...
from library.CEDOPADS_solvers.local_search_operators import remove_visit, add_free_visits, get_equidistant_samples
...
class GA:
    ...
    def pick_new_visit_based_on_sdr_and_index(self, individual: CEDOPADSInstance, idx: int, m: int = 5) -> Visit:
        ...
        visits_and_sdrs = []
        for visit in get_equidistant_samples(problem_instance, k):
