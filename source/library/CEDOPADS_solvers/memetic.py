...
class GA:
    ...
    def fix_length(self, individual: CEDOPADSRoute) -> CEDOPADSRoute: 
        ...
        states = self.problem_instance.get_states(individual)
    ...
    def angle_mutation (self, individual: CEDOPADSRoute, q: float) -> CEDOPADSRoute:
        ...
        for idx, (k, _, _, r) in enumerate(individual):
            ...
            if u < q:
                ...
                interval: AngleInterval = np.random.choice(self.problem_instance.nodes[k].AOAs, size = 1, p = interval_probabilities)[0]
